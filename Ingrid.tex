...
\begin{abstract}
  Very Long Baseline Interferometry (VLBI) is a technique in astronomy
  where several distant radio telescopes observe the same source and
  the received signals are recorded and later correlated to produce an
  image with a large resolution.
  ...
  hardware correlator processes the experiments. Within \scarie\ we
  investigate the capabilities of a next generation software
