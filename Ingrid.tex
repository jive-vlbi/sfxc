...
\begin{abstract}
  In this paper we present the progress of the \scarie\ project in which 
  ...
  our software correlator, and on challenges of running real-time 
  scientific experiments on top of grids infrastructure. This paper 
  also contains experimentals results on both software correlation 
  as well our current experiments based on the DAS-3 grid and its 
