...
\acomment{What about copying this into the introduction of eVLBI} 
...
\acomment{Can we explain more simply correlation.}{
...
\acomment{Sizing and optimization should be introduce later. }{The high data rates and the optimizations complicate the process.}
...
Figure~\ref{fig:correlation_diagram}. \acomment{Justifiy why we give these details}{ This process requires very accurate timing information in the data and a very detailed model of the geometry of the experiment}. After \acomment{added.}{the application of delay} the signals are properly aligned, the signals are ready to be correlated. Correlation is \acomment{mathematically defined as...}{ a well defined mathematical function~\cite{def_correlation} on two signals }in
which \acomment{is this the mathematical definition or JIVE hardware correlator implenentation}{the first signal is delayed with discrete steps and the integral
...
\paragraph{{\it e}-VLBI}
\acomment{What do you think about putting e-VLBI somewhere else ?}{}
