    ...
    *************************************/
    ...
    private:
        ...
        Buffer_element(pType data);
				...
				void set_owner(Memory_pool<T>* owner);
...
template<class T>
typename Memory_pool<T>::pType Memory_pool<T>::allocate()
{
    RAIIMutex rc(m_freequeuecond);
...
template<class T>
void Memory_pool<T>::release(pType element)
{
...
template<class T>
Memory_pool<T>::Buffer_element::Buffer_element(pType data)
{
    MASSERT( data  != NULL );
...
template<class T>
typename Memory_pool<T>::Buffer_element::pType Memory_pool<T>::Buffer_element::data()
{
    return m_data;
}

template<class T>
void Memory_pool<T>::Buffer_element::set_owner( Memory_pool<T>* owner )
{
