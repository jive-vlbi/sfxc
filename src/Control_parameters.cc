...
double
Control_parameters::
sample_rate(const std::string &if_ref) const {
/// TODO : get the mode from the scan
  std::string if_mode_freq;
  double samplerate;
  ...
  samplerate = vex.get_root_node()["FREQ"][if_mode_freq]["sample_rate"]->to_double_amount("Ms/sec");
